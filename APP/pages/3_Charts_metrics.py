...
def load_all_datasets(data_path=' A-Data-Driven-Analysis-Model-for-Kenya_s-Health-Facility-Landscape/DATA/CLEANED DATA (CSV)/GEOCODED'):
...
def load_population_data(data_path=' A-Data-Driven-Analysis-Model-for-Kenya_s-Health-Facility-Landscape/DATA/CLEANED DATA (CSV)/'):
